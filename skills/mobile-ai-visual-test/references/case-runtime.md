...
| 方法 | 用途 | 紧凑签名 |
|---|---|---|
| [`observe`](case-runtime/methods/observe.md) | 采集一个新 Scene，不执行业务动作。 | `observe({ capability: "observe", purpose?: string })` |
...
| [`act`](case-runtime/methods/act.md) | 基于当前 Scene 执行一个 ActionRef，并采集新 Scene。 | `act({ capability: "act", basedOnSceneRef: string, actionRef: string, input?: object, purpose: string })` |
...
| [`finish`](case-runtime/methods/finish.md) | 从 expectation ledger 收口并完成用例。 | `finish({ capability: "finish", summary: string, uncertainties?: string[] })` |
