...
| [`runPlan`](case-runtime/methods/run-plan.md) | 连续执行受约束的短时动作、等待、采集、定位和技术检查计划。 | `runPlan({ capability: "runPlan", submissionId: string, basedOnSceneRef: string, purpose: string, maxDurationMs: number, onFailure: "STOP" | "CONTINUE", steps: object[], flowContext?: object })` |
