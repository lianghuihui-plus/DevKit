...
| [`knowledge`](case-runtime/methods/knowledge.md) | 查询知识，或登记指定 query 的候选复核结果。 | `knowledge({ capability: "knowledge", basedOnSceneRef: string, query?: string, checkNodeRefs?: string[], flowContext?: object, queryId?: string, conclusion?: "APPLICABLE_FOUND" | "NO_APPLICABLE" | "CONFLICTING" | "INSUFFICIENT", assessments?: object[] })` |
...
| [`finish`](case-runtime/methods/finish.md) | 从 CHECK ledger 收口并完成用例。 | `finish({ capability: "finish", summary: string, uncertainties?: string[], flowContext?: object, outcome?: "NOT_RUN", reason?: string, evidence?: object })` |
