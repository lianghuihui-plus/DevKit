...
const suites = Object.freeze({
  ...
  harmonyLayout: 'tests/harmony-layout-capture.test.js',
  platformCapture: 'tests/platform-capture.test.js',
  ...
  actionPlanDispatch: 'tests/action-plan-dispatch.test.js',
  planContract: 'tests/plan-contract.test.js',
  planLocator: 'tests/plan-locator.test.js',
  planChecks: 'tests/plan-checks.test.js',
  planService: 'tests/plan-service.test.js',
  planReport: 'tests/plan-report.test.js',
  runPlan033: 'tests/run-plan-033.test.js',
  ...
  finalReviewGate: 'tests/final-review-gate.test.js',
