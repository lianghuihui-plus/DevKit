...
console.log(JSON.stringify({schemaVersion:1,type:"actionResult",platform:"android",time:localIso(),action:"tap",ok:true,executedPoint:{x:Number(process.argv[1]),y:Number(process.argv[2])}}, null, 2));
' "$x" "$y"
