...
assert.strictEqual(narrative.steps[0].action.result.screenComparison, undefined);
assert.deepStrictEqual(narrative.steps[0].action.result.evidence.sceneRefs, {
  before: 'scene-0001',
  after: 'scene-0002',
});
