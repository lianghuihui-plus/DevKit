...
assert.strictEqual(action.coordinateScreenshot.ref, 'coordinate-audits/action-0001.svg');
assert.strictEqual(action.coordinateScreenshot.baseRef, 'screenshots/scene-0001.png');
assert.strictEqual(action.actionEffect.status, 'NO_VISIBLE_CHANGE');
