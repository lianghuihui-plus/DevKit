...
![](./单元测试框架使用指导-自动化测试框架使用指导-单元测试和UI测试-应用测试 - 华为HarmonyOS开发者_files/zh-cn_image_0000002581217681.png)
...
![](./单元测试框架使用指导-自动化测试框架使用指导-单元测试和UI测试-应用测试 - 华为HarmonyOS开发者_files/zh-cn_image_0000002550777586.png)
...
![](./单元测试框架使用指导-自动化测试框架使用指导-单元测试和UI测试-应用测试 - 华为HarmonyOS开发者_files/zh-cn_image_0000002581377645.png)
